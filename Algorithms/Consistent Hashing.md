...
- [Sharding](../Databases/Sharding.md) — consistent hashing is one of several shard key assignment strategies; the note covers the full landscape including range and directory-based approaches
